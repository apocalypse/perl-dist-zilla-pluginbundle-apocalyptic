...
#	[GenerateFile / MANIFEST.SKIP]	; make our default MANIFEST.SKIP
	# List generated by looking at ExtUtils::Manifest and Module::Build's code + other authors's MANIFEST.SKIP :)
...
The PAUSE id you want to use when building the dist. As of now it's only used for the L<Dist::Zilla::Plugin::Authority> but in the future
there might be other uses for it. Required.
